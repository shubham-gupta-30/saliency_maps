...
ROOT_DIR = Path("/home-local2/shgup1.extra.nobkp/tiny-imagenet")
DATASET_ZIP = ROOT_DIR / "tiny-imagenet-200.zip"
...
ORIGINAL_DATASET_DIR = ROOT_DIR/ "original"
